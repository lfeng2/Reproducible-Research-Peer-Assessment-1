...
qplot(total.steps, binwidth = 1000) + geom_histogram(colour="blue", fill="blue", binwidth = 1000) 
+ xlab("Histogram of the total number of steps taken each day")
ggplot(total.steps) + geom_histogram(colour="blue", fill="blue", binwidth = 1000) 
+ xlab("Histogram of the total number of steps taken each day")
qplot(total.steps, binwidth = 1000, xlab = "Histogram of the total number of steps taken each day")
+ geom_histogram(colour="blue", fill="blue", binwidth = 1000)
qplot(total.steps, binwidth = 1000, xlab = "Histogram of the total number of steps taken each day")
```
